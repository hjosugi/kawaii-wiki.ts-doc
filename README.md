...
This repository is the source of truth for Markdown shown on the [official documentation site](https://kawaii-wiki-ts-docs.up.railway.app/docs/home). Edit files under [`content/docs`](content/docs); commits to `main` are imported into the wiki on the next sync, normally within five minutes. Wiki edits are committed back here automatically. SQLite and uploaded assets still require a separate backup.
