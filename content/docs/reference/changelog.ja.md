...
> 日本語版の変更履歴は未整備です。以下は `CHANGELOG.md` の英語原文です。

> sourceの変更履歴は現在 `1.0.29` までです。タグ `v1.0.30`〜`v1.0.32` と、その後の未リリース `main` の運用上重要な差分は [[docs/database-and-search|データベースと検索]] にまとめています。
