...
> The source changelog currently ends at `1.0.29`. Tags `v1.0.30` through `v1.0.32` and later unreleased `main` work are summarized in [[docs/database-and-search.en|Databases and Search]] where they affect operation.
